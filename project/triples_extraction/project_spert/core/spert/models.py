...
class SpERT(BertPreTrainedModel):
    """ Span-based models to jointly extract entities and relations """
    ...
    def _classify_entities(self, encodings, h, entity_masks, size_embeddings):
        ...
        # print('cls token', self._cls_token)
        entity_ctx = get_token(h, encodings, self._cls_token)

        # create candidate representations including context, max pooled span and size embedding
        # print('ctx shape', entity_ctx.shape)
        # print('spans_pool shape', entity_spans_pool.shape)
        # print('size embedding shape', size_embeddings.shape)
