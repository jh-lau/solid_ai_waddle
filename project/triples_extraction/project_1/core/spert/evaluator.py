...
class Evaluator:
    ...
    def eval_batch(self,
        ...
        for i in range(batch_size):
            # get models predictions for sample
            ...
            rel_types = (rel_nonzero % rel_class_count) + 1  # models does not predict None class (+1)
    ...
    def get_prediction(self):
        return self._pred_entities, self._pred_relations
