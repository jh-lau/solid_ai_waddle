...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--model_path', type=str, help="Path to directory that contains models checkpoints")
    arg_parser.add_argument('--model_type', type=str, default="spert", help="Type of models")
...
def train_argparser():
    ...
    # Logging
    arg_parser.add_argument('--save_path', type=str, help="Path to directory where models checkpoints are stored")
    ...
    arg_parser.add_argument('--save_optimizer', action='store_true', default=False,
                            help="Save optimizer alongside models")
    ...
    arg_parser.add_argument('--final_eval', action='store_true', default=False,
                            help="Evaluate the models only after training, not at every epoch")
